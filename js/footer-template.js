function loadFooter(currentPagePath) {
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8" data-source-file="src/components/common/Footer.tsx" data-source-line-start="73" data-source-line-end="164">
                    ...
                    <div data-source-file="src/components/common/Footer.tsx" data-source-line-start="107" data-source-line-end="121">
                        ...
                        <ul class="space-y-2" data-source-file="src/components/common/Footer.tsx" data-source-line-start="109" data-source-line-end="120">
                            <li data-source-file="src/components/common/Footer.tsx" data-source-line-start="111" data-source-line-end="118"><a href="${basePath}climatisation/" class="text-sm text-muted-foreground hover:text-primary transition-colors" data-source-file="src/components/common/Footer.tsx" data-source-line-start="112" data-source-line-end="117">Climatisation</a></li>
                            <li data-source-file="src/components/common/Footer.tsx" data-source-line-start="111" data-source-line-end="118"><a href="${basePath}ventilation/" class="text-sm text-muted-foreground hover:text-primary transition-colors" data-source-file="src/components/common/Footer.tsx" data-source-line-start="112" data-source-line-end="117">Ventilation</a></li>
                            <li data-source-file="src/components/common/Footer.tsx" data-source-line-start="111" data-source-line-end="118"><a href="${basePath}plomberie/" class="text-sm text-muted-foreground hover:text-primary transition-colors" data-source-file="src/components/common/Footer.tsx" data-source-line-start="112" data-source-line-end="117">Plomberie</a></li>
                        </ul>
                    </div>
                    ...
                    <div data-source-file="src/components/common/Footer.tsx" data-source-line-start="124" data-source-line-end="138">
                        ...
                        <ul class="space-y-2" data-source-file="src/components/common/Footer.tsx" data-source-line-start="126" data-source-line-end="137">
                            <li data-source-file="src/components/common/Footer.tsx" data-source-line-start="128" data-source-line-end="135"><a href="${basePath}index.html" class="text-sm text-muted-foreground hover:text-primary transition-colors" data-source-file="src/components/common/Footer.tsx" data-source-line-start="129" data-source-line-end="134">Accueil</a></li>
                        </ul>
                    </div>
    ...
    if (footerPlaceholder) {
        ...
        console.error("Elemen dengan ID 'footer-placeholder' tidak ditemukan.");
    }
}